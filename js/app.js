...
var CELULAR_EMPRESA = '5511995592303';
...
cardapio.metodos = {
    ...
    obterItensCardapio: (categoria ='burgers', vermais = false) => {
        ...
        //seta o menu correspondente para ativo
    ...
    buscarCep:() => {
        ...
        if (cep != "") {
            ...
            // expressão regular para validar o CEP (regEx)
            var validacep = /^[0-9]{8}$/;
    ...
    mensagem: (texto, cor = 'red', tempo = 3500) => {
        ...
        //removendo a mensagem de adição no carrinho
        setTimeout(() => {
